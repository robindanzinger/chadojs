...
describe("combines different arrays", function () {
  ...
  it('combine three arrays', function () { 
    ...
    expect(result).eql([['A1', 'B1', 'C1']]);
  }), 
  it('empty array should be ignored', function () {
    var emptyArray = [];
    var arrayA = ['A1'];
    expect(combine(arrayA, emptyArray)).eql([['A1']]);
    expect(combine(emptyArray, arrayA)).eql([['A1']]);
  }),
