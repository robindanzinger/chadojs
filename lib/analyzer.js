...
function getUnusedAssumptions(array) {
  var groups = groupAssumptions(array);
  return groups.filter(function (group) { return group.assume === true && group.calledBy !== true; });
}

function getAllAssumptions(array) {
  var groups = groupAssumptions(array);
  return groups.filter(function (group) { return group.assume === true; });
}

function getAllVerifications(array) {
  var groups = groupAssumptions(array);
  return groups.filter(function (group) { return group.verify === true; });
}
