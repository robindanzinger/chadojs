...
function assume(repo, lib) {
      ...
      lib[funcName] = function () {
        ...
        if (isThrowErrorDefined(actualStringifiedArgs)) {
          ...
          save([libName, funcName, actualStringifiedArgs, createThrowErrorActionString(errorMessage), 
              'calledBy', trackInfoCalledBy.file, trackInfoCalledBy.line, trackInfoCalledBy.func])
            .to(repo);
  ...
  function saveAssumption(actionString) {
    save([libName, funcName, expectedStringifiedArgs, actionString, 'assume', trackInfoOfAssumption.file, trackInfoOfAssumption.line, trackInfoOfAssumption.func]).to(repo);
  }
