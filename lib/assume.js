...
function createCallbackAssumption(repo, collaborator, funcName, args, callbackArgs, callbackIndex, trackInfo) {
  ...
  saveAssumption(repo, collaborator, funcName, args, 
                createCallbackActionString(callbackIndex, callbackArgs), 
                trackInfo);
}
...
function saveAssumption(repo, collaborator, funcName, args, actionString, trackInfoOfAssumption) {
  ...
  save([testdoubleName, funcName, args, actionString, 'assume', 
        trackInfoOfAssumption.file, trackInfoOfAssumption.line, 
        trackInfoOfAssumption.func, trackInfoOfAssumption.test])
    .to(repo);
}
